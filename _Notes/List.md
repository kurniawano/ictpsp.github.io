...
```python
>>> week1_steps: list[int] = [40, 45, 50]
>>> week2_steps: list[int] = [55, 52, 60]
>>> week1_and_2: list[int] = week1_steps + week2_steps
>>> week1_and_2
[40, 45, 50, 55, 52, 60]
```
...
>>> my_steps
[65, 50, 52, 52]
>>> first_pos: int = my_steps.index(52)
>>> first_pos
2
>>> second_pos: int = my_steps.index(52, first_pos + 1)
>>> second_pos
3
```
